// ============================================================
// 👤 DASHBOARD.JS — ЛИЧНЫЙ КАБИНЕТ (v6)
// ============================================================
...
onAuthStateChanged(auth, async (user) => {
  ...
  if (!result.success) {
    showModal(
      'Аккаунт не найден или заявка ещё не одобрена админом.\n\nЕсли ты только что зарегистрировался — подожди одобрения.',
      {
        title: 'Нет доступа',
        icon: '⚠️',
        okText: 'Выйти',
  ...
  if (listingForm) {
    listingForm.addEventListener('submit', async (e) => {
      ...
      const doPublish = async () => {
        ...
        // ✅ Флаг premium — всегда boolean, никогда undefined
