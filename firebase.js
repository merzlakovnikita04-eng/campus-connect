...
async function savePending(studentId, data) {
  try {
    console.log('📝 Сохраняем заявку:', studentId, data);
...
export {
  ...
  convertIdToEmail, hashPassword,
  registerStudent, loginStudent, logoutStudent, onAuthStateChanged,
  savePending, getPending, deletePending,
  getStudents, saveStudent, deleteStudent,
  getAds, saveAd, deleteAd,
  getListings, saveListing, deleteListing,
  getAbsences, saveAbsence, deleteAbsence,
  getVotes, saveVotes,
  collection, doc, getDoc, getDocs, setDoc, deleteDoc, updateDoc, query, where, onSnapshot
};
